...
import photo1 from '../../images/photo1belowslider.webp'
import photo2 from '../../images/photo3belowslider.jfif'
      ...
      {loading ? (
        ...
        <Fragment>
          ...
          <div className="banner">
            <p>Welcome to Pratham Cosmetics</p>
        ...
        <img style={{float:"left", width:"540px", height:"359px"}}src={photo1} alt="cosmetics" /><h1 className= "heading0"><h1 className="heading00">Click Here to Buy Trending Products</h1></h1>
        </a>
        </div>
        
       
        <div>
          <a style={{textDecoration:"none"}} href="http://localhost:3000/products/tya" alt="">
